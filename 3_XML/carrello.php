...
?>
        <li><?php echo($articolo['nome']); ?>, <?php echo($articolo['prezzo']); ?> &euro;
          <form class="mt-8" action="carrello.php" method="post">
            ...
            <button type="submit" name="azione" value="modifica" class="button ml-8">&#x01F4DD</button>
            <button type="submit" name="azione" value="rimuovi" class="button ml-8">&#x01F5D1</button>
          </form>
        </li>
